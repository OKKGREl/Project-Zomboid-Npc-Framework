...
local function PZNS_Events()
	...
	Events.EveryOneMinute.Add(PZNS_GeneralAI.PZNS_TryHealingEverySurvivor); -- okkg: Needs a different way so its optimized...	
    Events.LoadGridsquare.Add(PZNS_WorldUtils.PZNS_SpawnNPCIfSquareIsLoaded); -- okkg: change to load chunk later
